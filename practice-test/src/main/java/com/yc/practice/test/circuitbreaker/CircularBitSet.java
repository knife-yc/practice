...
public class CircularBitSet {
    ...
    /**
     * Copies the most recent bits from the {@code left} BitSet to the {@code right} BitSet in order
    ...
    /**
     * Sets the value of the next bit in the bitset, returning the previous value, else -1 if no
     * previous value was set for the bit.
     */
